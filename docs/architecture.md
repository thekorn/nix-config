...
| `home/shared/profiles/linux-vm-desktop.nix` | Desktop Linux VM setup layered on `linux-vm.nix`, with Hyprland, Waybar, launcher, notifications, and Wayland tools |
